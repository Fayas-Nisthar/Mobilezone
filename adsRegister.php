            ...
            <section class="container mt-1">
                ...
                <h6>Admin Dashbord</h6>
                    <div class="col-sm-4 list-group">
                        ...
                        <a href="adsRegister.php" class="list-group-item list-group-item-action active">Ads Registered</a>
                        <a href="orderRegister.php" class="list-group-item list-group-item-action">Orders Registered</a>
                        <a href="feedbackReceived.php" class="list-group-item list-group-item-action">Feedback Received</a>
                        ...
                        <?php   
                            ...
                            ?>
                                        <tbody>
                                            ...
                                            <td><?php echo $row['mobileModel'];?></td>
                                            <td><?php echo $row['userID'];?></td>
                                            <td>                                                
                                                <form method="POST" id="showMore" action="adminMobileShow.php">
                                                ...
                                                <form class="mt-1" id="deleter" method="POST" action="adsDelete.php">
                                                    <select hidden name="deleteMobile">
