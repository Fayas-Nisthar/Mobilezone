...
if (isset($_SESSION['id']) && isset($_SESSION['email'])) {
    ...
    $getsql = "SELECT * FROM mobiles WHERE userID = ".$userID.";";
            ...
            <section class="container mt-1">
                <div class="row">
                    ...
                    <div class="col-sm-4 list-group">
                        ...
                        <a href="userAds.php" class="list-group-item list-group-item-action active">Mobile Ads</a>
                                ...
                                <div class="card p-1">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-2 py-3">
                                            ...
                                            <div class="d-flex justify-content-center mx-auto ">
                                                <form class="mt-1" id="deleter" method="POST" action="adDelete.php">
