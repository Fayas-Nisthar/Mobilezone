        ...
        <div class="container">
            ...
            <section class="container mt-1">
                ...
                <div class="col-sm-4 list-group">
                        ...
                        <a href="adsRegister.php" class="list-group-item list-group-item-action">Ads Registered</a>
                        <a href="orderRegister.php" class="list-group-item list-group-item-action">Orders Registered</a>
                        <a href="feedbackReceived.php" class="list-group-item list-group-item-action active">Feedback Received</a>
                    ...
                    <div class="col-sm-8 feedMargin mx-auto">
                        ...
                        <?php   
                            ...
                            ?>
                                        <tbody>
                                            <tr>
                                            <th scope="row"><?php echo $row['feedback'];?></th>
                                            <td><?php echo $row['userID'];?></td>
                                            <td>      
                                                <form class="mt-1" id="deleter" method="POST" action="feedbackDelete.php">
                                                    <select hidden name="deleteFeedback">
