      ...
      <div class="container-fluid">
        <nav class="navbar sticky-top navbar-light bg-light border-bottom border-2">
            <div class="container-fluid">
                ...
                <a class="navbar-brand fw-bolder" href="index.php">Mobilezone</a>

                <ul class="nav justify-content-end">
                    <li class="nav-item">
                      <a class="nav-link link-dark" href="loginForm.php"><b>Login</b></a>
                    </li>
                  </ul>
        ...
        <div class="jumbotron text-white jumbotron-image shadow p-5 text-center shadow-1-strong rounded mb-5 text-white" style="background-image: url(icons/banners.png);">
          <h1 class="display-4">Welcome to MOBILEZONE</h1>
          <p class="lead">Used Mobile Selling and Buying Platform.</p>
       
          <div class="mask pt-4 pb-4 rounded" style="background-color: rgba(0, 0, 0, 0.6)">
            <p>Our mission is to create an application that is helpful for selling and buying of used Mobile. <br> Lets get started by signing up first!</p>
            <p class="lead pt-2">
            <a class="btn btn-outline-dark btn-light btn-lg" href="signup.php" role="button">Get Started</a></p>
            </div>
        </div>
        ...
        <div class="container">  
          <h2 class="text-center py-4 font-weight-bold">Features of Mobilezone :</h2>  
          <div class="row justify-content-center">
            <div class="col-sm-4 px-4 py-4">
              <div class="panel panel-primary">
                <div class="panel-heading text-center"><h3>Selling Mobile are Easy</h3></div><br>
                <div class="panel-body text-center"><img src="icons/mobilesell.jpg" class="img-responsive" style="width:50%" alt="Image"></div><br>
                <div class="panel-footer text-center">Selling your mobile has never become this easy. All you need is a minute to upload your mobile details and you are good to go.</div>
              </div>
            </div>
            <div class="col-sm-4 px-4 py-4"> 
              <div class="panel panel-primary">
                <div class="panel-heading text-center"><h3>Find your favourite mobile</h3></div><br>
                <div class="panel-body text-center"><img src="icons/mobile.jpg" class="img-responsive" style="width:50%" alt="Image"></div><br>
                <div class="panel-footer text-center">Browse through the hundreds of options posted by genuine sellers and find your favourite mobile here at the best ever prices.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">    
          <div class="row justify-content-center">
            <div class="col-sm-4 px-4 py-4">
              <div class="panel panel-primary">
                <div class="panel-heading text-center"><h3 class="font-weight-bold">Easy to Use</h3></div><br>
        ...
        <footer class="page-footer font-small bg-secondary stylish-color-dark pt-4">
          ...
          <hr>
            <ul class="list-unstyled list-inline text-center py-2">
              ...
              <li class="list-inline-item"><a href="signup.php" class="btn btn-light btn-rounded">Sign up</a></li>
            </ul>
          <hr>
        </footer>
      </div>
